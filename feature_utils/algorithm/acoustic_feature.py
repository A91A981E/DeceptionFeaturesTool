...
class OpenSmileFeatureSet:
    ...
    def feature_extraction(self, config_file, output_file):
        ...
        # subprocess.run(self.openSmile_path + cmd, shell=True)
...
class RhythmFeatures:
    ...
    def plot(self, energy="ste", show=True):
        ...
        # wave_ax.legend(prop={'size': 10,}, loc="upper right",
...
if __name__ == "__main__":
    ...
    wave_file = os.path.join(current_path, "audios/trial_truth_001_audio.wav")
